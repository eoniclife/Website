/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: d529f04f0d1ce3d3e81846db81d0d732)
// Runtime types generated with workerd@1.20260317.1 2026-03-21 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* eonic-life */;
	}
}
